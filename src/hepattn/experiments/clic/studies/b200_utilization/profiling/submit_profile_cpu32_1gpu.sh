...
#SBATCH --job-name=clic-profile-cpu32
#SBATCH -p hpg-b200
...
# Run the profiling run (Phase 1: SimpleProfiler, 200 steps, no validation)
echo "Running profiling run..."

# Python command that will be run
PYTORCH_CMD="python main.py fit --config configs/base.yaml --config configs/profile.yaml --config configs/profile_cpu32.yaml --trainer.devices=1"

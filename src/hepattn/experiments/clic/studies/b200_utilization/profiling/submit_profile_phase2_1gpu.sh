...
#SBATCH --job-name=clic-profile2-1gpu
#SBATCH -p hpg-b200
...
# Run the profiling run (Phase 2: PyTorchProfiler, 12 steps, eager mode, no validation)
echo "Running Phase 2 profiling run..."

# Python command that will be run
PYTORCH_CMD="python main.py fit --config configs/base.yaml --config configs/profile_phase2.yaml --trainer.devices=1"
